            ...
            <div class="row">
                <div class="col-md-3">
                    <!-- <div class="form-group ">
                          ...
                          <input type="text" class="form-control" id="STIN_seller" placeholder="" name="STIN_seller" >
                    </div> -->

                  <div class="form-group ">
                        <label for="STIN_seller" id="text-stock-in">บริษัทผู้ขาย</label>

                        <select class="custom-select  rounded-0" id="STIN_seller" placeholder="" name="STIN_seller" >
                        <option selected="selected" value=""></option>
                        <?php
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="exampleFormControlTextarea1" name="stockin_remark" rows="1"></textarea>
                </div>
                ...
                <div class="row">
                  <div class="col-4">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="number" class="form-control form-control-sm" id="update_qty" placeholder="" name="update_qty" disabled>
                    </div>
                  ...
                  <div class="col-4">
                    ...
                    <div class="form-group ">
                        <label for="STIN_id_po" id="text-stock-in">เลขที่ใบสั่งซื้อ</label>
                        <input  type="text" class="form-control" id="update_id_po" placeholder="" name="update_id_po" >
                </div>
                  ...
                  <div class="col-4">
                    ...
                    <div class="form-group ">
                        <label for="update_serial_group" id="text-stock-in">Serial Number Group</label>
