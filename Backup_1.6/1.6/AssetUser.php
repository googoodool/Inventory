  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="card card-default">
        ...
        <form action="Code_Add_AssetUser.php" method="POST" enctype="multipart/form-data">
<!-- ======================  ROW 1 ====================== -->
            <div class="row">
                <div class="col-md-3">
                  ...
                  <tbody id="FixHistory_tbody">
                      <?php
                         ...
                         while($row = $select->fetch(PDO::FETCH_ASSOC)){
                            ...
                            <td>
                                <a href="Asset_image/'.$pic.'"class="fancybox2" title="'.$row['name'].'" data-fancybox-group="gallery">
                            ...
                            <td>'.$row['id_po'].'</td>
                            <td>'.$row['create_remark'].'</td>
                            
                            <td>'.$row['create_date'].'</td>
                            <td>'.$row['create_by'].'</td>
                            <td>'.$row['update_date'].'</td>
                            <td>'.$row['update_by'].'</td>
                            <td>'.$row['update_remark'].'</td>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog bg-danger">
          <div class="modal-content bg-danger">
            ...
            <form action="Code_Add_AssetUser.php" method="POST">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="post"  action="Code_Add_AssetUser.php" enctype="multipart/form-data">
