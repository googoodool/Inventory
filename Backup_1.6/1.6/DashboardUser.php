                ...
                <div class="progress-group">
                  ...
                  <span class="float-right"><b>'.$cat_row['QTY'].'</b>/'.$cat_row['total'].'</span>
                    <div class="progress progress-sm">
                      <div class="progress-bar " style="width: '.$cat_row['percentage'].'%;background-color:#31AA14"></div>
                    </div>
                </div>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <?php
              ...
              FROM asset  GROUP BY name ORDER BY name ASC");
              ...
              while($asset_row = $asset_select->fetch(PDO::FETCH_ASSOC)){
                ...
                <div class="progress-group">
                  ...
                  <span class="float-right"><b>'.$asset_row['QTY'].'</b>/'.$asset_row['total'].'</span>
                    <div class="progress progress-sm">
                    ...
                    <?php
                       ...
                       while($row = $select->fetch(PDO::FETCH_ASSOC)){
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="progress progress-sm">
                              <div class="progress-bar" role="progressbar" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100" style="width: '.$percent.'%;background-color:#31AA14">
                              </div>
                            </div>
