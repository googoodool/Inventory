  ...
  <footer class="main-footer">
    <!-- To the right -->
    <div style="color:darkslateblue" class="float-right d-none d-sm-inline" >
      PAT INVENTORY STOCK Rev 1.6
    </div>
    <!-- Default to the left -->
    <strong style="color:darkslateblue">Copyright &copy; 2021 PAT INNOVATIVE SOLUTION.</strong>
  </footer>
</div>
<!-- ./wrapper -->
