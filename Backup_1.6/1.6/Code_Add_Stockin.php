...
$stockin_remark = $_POST['stockin_remark'];
    ...
    if(isset($_POST['STIN_name'])){
            ...
            qty,price,seller,id_quotation,date_quotation,id_po,create_name,status,date_receive,serial_group,stockin_remark)
            VALUES (:a,:b,:c,:d,:e,:f,:g,:i,:j,:k,:l,:m,:n,:o,:p)");
...
if(isset($_POST['stockout_submit'])){
  ...
  $select = $pdo->prepare("UPDATE stockin_insert SET stockout_project = '$project_out', stockout_date='$date_out', stockout_by='$name', status='$status', stockout_createdate = NOW(), stockout_remark='$stockout_remark'  WHERE id = '$update_id'");
...
if(isset($_POST['edit_submit'])){
  ...
  seller='$update_seller',stockin_remark='$update_remark',stockin_update_date = NOW(),stockin_update_by='$name'  WHERE id = '$update_id'");
