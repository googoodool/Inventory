            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <!-- <textarea name="stockin_remark" id="" cols="30" rows="10"></textarea> -->
              ...
              <form method="post"  action="Code_Add_stockin.php">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <div class="form-group ">
                        <label for="edit_serial" id="text-stock-in">Serial Product</label>
                        <input type="text" class="form-control form-control-sm" id="edit_serial" placeholder="" name="edit_serial" disabled>
                    </div>

                    <div class="form-group ">
                        <label for="edit_serial_group" id="text-stock-in">Serial Group</label>
  ...
  function generate()
    {
      ...
      document.getElementById("STIN_serial_gen").value='PAT-'+date+ '-'+i; 
    }
</script> -->
