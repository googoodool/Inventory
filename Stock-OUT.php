              ...
              <table id="example1" class="table table-striped" style="text-align:center">
                  <thead>
                      <tr>
                          ...
                          <th width="120px" id="text-stock-in">Image</th>
                          <th width="100px" id="text-stock-in">ประเภท</th>
                          ...
                          <th width="100px" id="text-stock-in">ราคาบาท</th>
                  ...
                  <?php
            $select = $pdo->prepare("SELECT ins_tab.*, cat_tab.cat_name, cat_tab.cat_image FROM stockin_insert ins_tab, category cat_tab WHERE ins_tab.item_name = cat_tab.cat_name AND ins_tab.status='STOCK-OUT' ORDER BY ins_tab.id DESC");
            $select->execute();
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <label id="text-stock-in">แก้ไขชื่อโครงการ </label>
                          <select class="custom-select  rounded-0" id="Stockout_project" placeholder="" name="Stockout_project" >
                      ...
                      <div class="col-md-6">
                        <div class="form-group ">
                          <label id="text-stock-in">แก้ไขประเภทโครงการ</label>
                          <select class="custom-select  rounded-0" id="Stockout_projectType" placeholder="" name="Stockout_projectType" >
                              <option value="">None Selected</option>
                              <?php
                      ...
                      <div class="col-md-6">
                         <div class="form-group ">
                          <label for="Stockout_update_price" id="text-stock-in">ราคา(บาท)</label>
                         <input type="text" class="form-control form-control-sm" id="Stockout_update_price" placeholder="" name="Stockout_update_price" >
                        </div>
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $.each(response, function (key, value) { 
            ...
            $( "#Stockout_project option:selected" ).text(value['stockout_project']);
            $( "#Stockout_project option:selected" ).val(value['stockout_project']);
            $( "#Stockout_projectType option:selected" ).text(value['stockout_project_type']);
            $( "#Stockout_projectType option:selected" ).val(value['stockout_project_type']);
            $( "#Stockout_edit_remark" ).val(value['stockout_remark']);
