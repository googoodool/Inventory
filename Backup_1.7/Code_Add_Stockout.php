...
if(isset($_POST['edit_submit'])){
  ...
  $select = $pdo->prepare("UPDATE stockin_insert SET stockout_project='$stockout_update_project',stockout_project_type='$stockout_update_projectType', stockout_remark='$stockout_update_remark',edit_stockout_date=NOW() ,edit_stockout_by='$name' WHERE id = '$update_id'");
