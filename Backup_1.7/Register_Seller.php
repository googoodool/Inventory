...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title" id="text-head-card">ข้อมูลบริษัทผู้ขาย</h3>
          ...
          <div class="card-body">
              <table id="example1" class="table table-striped" style="text-align:center" id="FixHistory_tbody">
                  ...
                  <?php
            $select = $pdo->prepare("SELECT * FROM seller ORDER BY id DESC");
            $select->execute();
...
<div class="modal fade" id="modal-insert">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post"  action="Code_Add_Seller.php">
...
<div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <form action="Code_Add_Seller.php" method="POST">
