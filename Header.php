      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <i style="color:#fff" class="fas fa-hand-holding-usd nav-icon"></i>
              <p>
                ค่าใช้จ่ายโครงการ
              </p>
            </a>
          ...
          <li class="nav-item ">
            <a href="#" class="nav-link">
              <i style="color:#fff" class="nav-icon fas fa-file-invoice-dollar"></i>
              <p>
                Report
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="sum_payment.php" class="nav-link ">
                <i style="color:yellow" class="far fa-circle nav-icon"></i>
                  <p>ค่าใช้จ่ายโครงการ</p>
                </a>
              </li>
