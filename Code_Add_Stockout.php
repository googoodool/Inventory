...
if(isset($_POST['edit_submit'])){
  ...
  $stockout_update_projectType  = $_POST['Stockout_projectType'];
  $stockout_update_remark       = $_POST['Stockout_edit_remark'];
  $stockout_update_price        = $_POST["Stockout_update_price"];

  $select = $pdo->prepare("UPDATE stockin_insert SET stockout_project='$stockout_update_project',stockout_project_type='$stockout_update_projectType',price_bath=$stockout_update_price, stockout_remark='$stockout_update_remark',edit_stockout_date=NOW() ,edit_stockout_by='$name' WHERE id = '$update_id'");
