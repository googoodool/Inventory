            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group ">
                        ...
                        <input type="ืnumber" class="form-control" id="STIN_price_thb" placeholder="" name="STIN_price_thb" required >
                    </div>
              ...
              <table id="example1" class="table table-striped" style="text-align:center">
                  <thead>
                      <tr>
                          ...
                          <th width="250px" id="text-stock-in">ชื่ออุปกรณ์</th>
                          <th width="120px" id="text-stock-in">ยี่ห้อ</th>
                          <th width="100px" id="text-stock-in">รุ่น</th>  
                          <th width="60px" id="text-stock-in">จำนวน</th>
                          <th width="250px" id="text-stock-in">บริษัทผู้ขาย</th>
